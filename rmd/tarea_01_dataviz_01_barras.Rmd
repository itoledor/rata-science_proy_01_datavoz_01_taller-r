...
## 2. Visualización de los Datos: Variable "Satisfacción con la vida"

Como ejemplo usaré la pregunta sobre satisfacción con la vida (`SV_1`), con esta variable mostraré distintas visualizaciones. Tu puedes usar la misma variable si así lo queires, pero te recomiendo fuertemente que intentes con una variable distina.
...
### Definiendo las variables estéticas

#### La variable estética `x`
...
gg_sv1_col_1 <- gg_sv1_col_1 %+% labs(subtitle = "count() + geom_col()")
...
gg_sv1_col_2 <- gg_sv1_col_2 %+% labs(subtitle = "count() + aes(fill) + geom_col()")
...
### Definiendo la posición de las barras
...
gg_sv1_col_3 <- gg_sv1_col_3 %+% labs(subtitle = "count() + aes(fill) + geom_col(position = 'stack')")
...
gg_sv1_col_4 <- gg_sv1_col_4 %+% labs(subtitle = "count() + aes(fill) + geom_col(position = 'dodge')")
...
gg_sv1_col_5 <- gg_sv1_col_5 %+% labs(subtitle = "count() + aes(fill) + geom_col(position = 'fill')")
